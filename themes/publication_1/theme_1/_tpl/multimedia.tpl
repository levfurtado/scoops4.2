                      ...
                      {{ if $multimediaType=="video" || $multimediaType=='audio'}}
                        {{ list_article_attachments length="1" }}
                            {{ if $multimediaType == "audio" }}
                              <a class="multimedia-link-sidebar" href="{{ uri options="article" }}#audioattachment">
                            {{ elseif $multimediaType == "video" }}
                              <a class="multimedia-link-sidebar" href="{{ uri options="article" }}#videoattachment">
                            {{ /if }}
                        {{ /list_article_attachments }}
                    {{ else }}
                              <a class="multimedia-link-sidebar" href="{{ uri options="article" }}#imageattachment">
