 ...
 */
class Issue extends \Newscoop\Subscription\Issue implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'issueNumber', 'startDate', 'days', 'paidDays', 'noticeSent', 'subscription', 'language');
    }
