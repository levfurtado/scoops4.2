 ...
 */
class Article extends \Newscoop\Subscription\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'articleNumber', 'startDate', 'days', 'paidDays', 'noticeSent', 'subscription', 'article', 'language');
    }
